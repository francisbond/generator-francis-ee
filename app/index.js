...
var FrancisExpressionEngineGenerator = yeoman.generators.Base.extend({
  init: function() {
  ...
  promptTask: function() {
    ...
    this.log(yosay('You\'re using Francis Bond\'s fantastic ExpressionEngine generator.'));
    ...
    },
    {
      ...
      default: 'ecommerce.francisbond.com'
    }], function(props) {
...
module.exports = FrancisExpressionEngineGenerator;
